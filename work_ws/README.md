...
# Run Python Script For Rviz Visualization. By default this reuses the
# robot_state_publisher already running on the robot:
ros2 launch salamander_bot display.launch.py

# For standalone visualization (without the robot mapping stack), also start it locally:
ros2 launch salamander_bot display.launch.py publish_state_publisher:=true
